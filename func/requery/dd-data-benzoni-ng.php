<?php
    if(!empty($requery_reference)){
        $curl_url = "https://".$api_detail["api_base_url"]."/api/v2/directdata/?api_key=".$api_detail["api_key"]."&order_id=".getTransaction($requery_reference, "api_reference")."&task=check_status";
