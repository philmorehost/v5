...
$check_column_query_1 = "SELECT * FROM information_schema.columns WHERE table_schema = '".$mySqlDBName."' AND table_name = 'sas_bulk_sms_sender_id' AND column_name = 'sample_message'";
$check_column_result_1 = mysqli_query($connection_server, $check_column_query_1);
if (mysqli_num_rows($check_column_result_1) == 0) {
...
if ($create_electric_purchased_table) {
	...
	$check_column_query_2 = "SELECT * FROM information_schema.columns WHERE table_schema = '".$mySqlDBName."' AND table_name = 'sas_electric_purchaseds' AND column_name = 'meter_owner_name'";
	$check_column_result_2 = mysqli_query($connection_server, $check_column_query_2);
	if (mysqli_num_rows($check_column_result_2) == 0) {
	...
	$check_column_query_3 = "SELECT * FROM information_schema.columns WHERE table_schema = '".$mySqlDBName."' AND table_name = 'sas_electric_purchaseds' AND column_name = 'meter_owner_address'";
	$check_column_result_3 = mysqli_query($connection_server, $check_column_query_3);
	if (mysqli_num_rows($check_column_result_3) == 0) {
...
if ($create_user_transaction_table) {
	...
	$check_column_query_4 = "SELECT * FROM information_schema.columns WHERE table_schema = '".$mySqlDBName."' AND table_name = 'sas_transactions' AND column_name = 'batch_number'";
	$check_column_result_4 = mysqli_query($connection_server, $check_column_query_4);
	if (mysqli_num_rows($check_column_result_4) == 0) {
