<?php
    $web_electric_size_array = array("ekedc"=>"eko-electric","eedc"=>"enugu-electric","ikedc"=>"ikeja-electric","jedc"=>"jos-electric","kedco"=>"kano-electric","ibedc"=>"ibadan-electric","phed"=>"portharcourt-electric","aedc"=>"abuja-electric","yedc"=>"yola-electric","bedc"=>"benin-electric","aple"=>"aba-electric","kaedco"=>"kaduna-electric");
