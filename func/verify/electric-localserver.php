<?php
    $web_electric_size_array = array("ekedc" => "ekedc", "eedc" => "eedc", "ikedc" => "ikedc", "jedc" => "jedc", "kedco" => "kedco", "ibedc" => "ibedc", "phed" => "phed", "aedc" => "aedc", "bedc" => "bedc", "aple" => "aple", "kaedco" => "kaedco");
