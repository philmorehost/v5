...
<div id="footerMenuDiv" style="height: 80px; border-radius: 40px 40px 0 0; user-select: auto;" class="color-1 bg-3 m-z-index-1 s-z-index-none m-scroll-x m-position-fix s-position-rel m-block-dp s-none-dp m-bottom-0 s-bottom-0 m-width-100 s-width-0">
	<a href="<?php echo $web_http_host; ?>/bc-admin/Airtime.php" class="a-cursor">
		<button style="left: auto; user-select: auto;" page-name="Airtime.php" class="footer-btn-js a-cursor bg-3 br-none outline-none m-inline-dp s-inline-block-dp m-position-abs s-position-rel m-bottom-0 m-width-20 m-height-100">
			<img src="<?php echo $web_http_host; ?>/asset/airtime-icon.svg" style="pointer-events: none; object-fit: contain; object-position: bottom; filter: brightness(10%);" class="footer-btn-img-js a-cursor bg-3 m-width-30 m-height-70"/><br/>
			<span style="filter: brightness(10%);" class="a-cursor color-8 text-bold-600 m-font-size-10">AIRTIME API</span>
		</button>
	</a>

	<a href="<?php echo $web_http_host; ?>/bc-admin/Cable.php" class="a-cursor">
		<button style="user-select: auto;" page-name="Cable.php" class="footer-btn-js a-cursor bg-3 br-none outline-none m-inline-dp s-inline-block-dp m-position-abs s-position-rel m-bottom-0 m-width-20 m-height-100">
			<img src="<?php echo $web_http_host; ?>/asset/cable-icon.svg" style="pointer-events: none; object-fit: contain; object-position: bottom; filter: brightness(10%);" class="footer-btn-img-js a-cursor bg-3 m-width-30 m-height-70"/><br/>
			<span style="filter: brightness(10%);" class="a-cursor color-8 text-bold-600 m-font-size-10">CABLE API</span>
		</button>
	</a>

	<a href="<?php echo $web_http_host; ?>/bc-admin/Dashboard.php" class="a-cursor">
	...
	<a href="<?php echo $web_http_host; ?>/bc-admin/SmeData.php" class="a-cursor">
		<button style="user-select: auto;" page-name="Data.php" class="footer-btn-js a-cursor bg-3 br-none outline-none m-inline-dp s-inline-block-dp m-position-abs s-position-rel m-bottom-0 m-width-20 m-height-100">
			<img src="<?php echo $web_http_host; ?>/asset/internet-icon.png" style="pointer-events: none; object-fit: contain; object-position: bottom; filter: brightness(10%);" class="footer-btn-img-js a-cursor bg-3 m-width-30 m-height-70"/><br/>
			<span style="filter: brightness(10%);" class="a-cursor color-8 text-bold-600 m-font-size-10">DATA API</span>
		</button>
	</a>
	
	<a href="<?php echo $web_http_host; ?>/bc-admin/Transactions.php" class="a-cursor">
