<?php session_start();
    ...
    $payment_gateway_array = array("monnify", "flutterwave", "paystack", "payvessel", "beewave", "vpay");
	$payment_gateway_webhook_array = array("monnify" => $web_http_host . "/users-monnify.php", "flutterwave" => $web_http_host . "/users-flutterwave.php", "paystack" => $web_http_host . "/users-paystack.php", "payvessel" => $web_http_host . "/users-payvessel.php", "beewave" => $web_http_host . "/users-beewave.php", "vpay" => $web_http_host . "/users-vpay.php");
        ...
        if(count($verification_name) > 0){
            foreach($verification_name as $index => $name){
                ...
                if(in_array($each_verification_name, $verification_array_list)){
                    $get_kyc_verification_details = mysqli_query($connection_server, "SELECT * FROM sas_kyc_verifications WHERE vendor_id='".$get_logged_admin_details["id"]."' && verification_name='$each_verification_name'");
                    if(mysqli_num_rows($get_kyc_verification_details) == 1){
                        mysqli_query($connection_server, "UPDATE sas_kyc_verifications SET status='$each_verification_status' WHERE vendor_id='".$get_logged_admin_details["id"]."' && verification_name='$each_verification_name'");
                        ...
                        if(mysqli_num_rows($get_kyc_verification_details) == 0){
                            mysqli_query($connection_server, "INSERT INTO sas_kyc_verifications (vendor_id, verification_name, status) VALUES ('".$get_logged_admin_details["id"]."', '$each_verification_name', '$each_verification_status')");
...
<body>
    <?php include("../func/bc-admin-header.php"); ?>    
		...
		<div style="text-align: center;" class="bg-10 m-block-dp s-block-dp m-position-rel s-position-rel br-radius-5px m-width-94 s-width-94 m-height-auto s-height-auto m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-padding-tp-5 s-padding-tp-3 m-padding-bm-5 s-padding-bm-3 m-margin-lt-2 s-margin-lt-2 m-margin-bm-2 s-margin-bm-2">
			<span style="user-select: auto;" class="text-bg-1 color-4 text-bold-500 m-font-size-20 s-font-size-25 m-inline-block-dp s-inline-block-dp m-margin-bm-1 s-margin-bm-1">VENDOR KYC</span><br>
					...
					foreach($kyc_verification_array as $verification_name){
						...
						if(in_array($get_verification_details["status"], array(1, 2))){
							if($get_verification_details["status"] == 1){
								...
								$verification_status = '<span style="color: ;" class="color-4 text-bold-600">Verification Forced</span>';
							}else{
								$verification_checkbox_value = "";
								$verification_status_value = "2";
								$verification_status = '<span style="color: ;" class="color-4 text-bold-600">Verification Disabled</span>';
							}
						}else{
							$verification_checkbox_value = "";
							$verification_status_value = "2";
							$verification_status = '<span style="color: ;" class="color-4 text-bold-600">Invalid Status Code</span>';
						}
						echo    '<span style="user-select: auto;" class="text-bg-1 color-4 text-bold-500 m-font-size-20 s-font-size-25 m-inline-block-dp s-inline-block-dp m-margin-bm-1 s-margin-bm-1">'.strtoupper($verification_name).'</span><br>
								<input style="text-align: center;" name="verification-name[]" value="'.$verification_name.'" hidden required/>
		
								<div style="text-align: center;" class="color-2 bg-3 m-inline-block-dp s-inline-block-dp m-width-60 s-width-45 m-margin-bm-2 s-margin-bm-2">
									<input '.$verification_checkbox_value.' id="verification-switch-'.$verification_name.'" name="verification-status-'.$verification_name.'" value="'.$verification_status_value.'" type="checkbox" class="outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none m-width-auto s-width-auto m-margin-bm-1 s-margin-bm-1" />
									<label for="verification-switch-'.$verification_name.'" style="user-select: auto;" class="a-cursor m-font-size-14 s-font-size-16">'.$verification_status.'</label>
								</div><br/>';
					}
				?>
		
				<button name="update-kyc-details" type="submit" style="user-select: auto;" class="button-box a-cursor outline-none color-2 bg-7 m-inline-block-dp s-inline-block-dp outline-none onhover-bg-color-5 br-radius-5px br-width-4 br-color-4 m-width-63 s-width-47 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" >
					UPDATE KYC DETAILS
				</button><br>
			</form>
		</div><br/>
        ...
        <div style="text-align: center;" class="bg-10 m-block-dp s-block-dp m-position-rel s-position-rel br-radius-5px m-width-94 s-width-94 m-height-auto s-height-auto m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-padding-tp-5 s-padding-tp-3 m-padding-bm-5 s-padding-bm-3 m-margin-lt-2 s-margin-lt-2 m-margin-bm-2 s-margin-bm-2">
            <span style="user-select: auto;" class="text-bg-1 color-4 text-bold-500 m-font-size-20 s-font-size-25 m-inline-block-dp s-inline-block-dp m-margin-bm-1 s-margin-bm-1">PAYMENT GATEWAYS</span><br>
            <form method="post" action="">
                <?php
                    foreach($payment_gateway_array as $gateway_name){
                        ...
                        echo    '<span style="user-select: auto;" class="text-bg-1 color-4 text-bold-500 m-font-size-20 s-font-size-25 m-inline-block-dp s-inline-block-dp m-margin-bm-1 s-margin-bm-1">'.strtoupper($gateway_name).'</span><br>
                                ...
                                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                                    <span id="admin-status-span" class="a-cursor" style="user-select: auto;">'.strtoupper("Public Key").'</span>
                                </div><br/>
                                <input style="text-align: center;" name="public-key[]" type="text" placeholder="'.ucwords($gateway_name).' Public Key" value="'.$get_gateway_details["public_key"].'" class="input-box outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none br-radius-5px br-width-4 br-color-4 m-width-60 s-width-45 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" /><br/>
                                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                                    <span id="admin-status-span" class="a-cursor" style="user-select: auto;">'.strtoupper("Secret Key").'</span>
                                </div><br/>
                                <input style="text-align: center;" name="secret-key[]" type="text" placeholder="'.ucwords($gateway_name).' Secret Key" value="'.$get_gateway_details["secret_key"].'" class="input-box outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none br-radius-5px br-width-4 br-color-4 m-width-60 s-width-45 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" /><br/>
                                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                                	<span id="admin-status-span" class="a-cursor" style="user-select: auto;">'.strtoupper("Encrypt Key").'</span>
                                </div><br/>
                                <input style="text-align: center;" name="encrypt-key[]" type="text" placeholder="'.ucwords($gateway_name).' Encrypt Key" value="'.$get_gateway_details["encrypt_key"].'" class="input-box outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none br-radius-5px br-width-4 br-color-4 m-width-60 s-width-45 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" /><br/>
                                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                                	<span id="admin-status-span" class="a-cursor" style="user-select: auto;">'.strtoupper("Payment Discount (%)").'</span>
                                </div><br/>
                                <input style="text-align: center;" name="payment-percent[]" type="number" step="0.001" min="1" max="100" placeholder="'.ucwords($gateway_name).' Percentage Discount" value="'.$get_gateway_details["percentage"].'" class="input-box outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none br-radius-5px br-width-4 br-color-4 m-width-60 s-width-45 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" /><br/>
                                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                                	<span id="admin-status-span" class="a-cursor" style="user-select: auto;">WEBHOOK</span>
                                </div><br/>
                                <input style="text-align: center;" name="" type="text" placeholder="'.ucwords($gateway_name).' Webhook" value="'.$payment_gateway_webhook_array[$gateway_name].'" class="input-box outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none br-radius-5px br-width-4 br-color-4 m-width-60 s-width-45 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" readonly/><br/>
                                <div style="text-align: right;" class="color-2 bg-3 m-inline-block-dp s-inline-block-dp m-width-60 s-width-45 m-margin-bm-2 s-margin-bm-2">
                                    <input '.$gateway_checkbox_value.' id="gateway-switch-'.$gateway_name.'" name="gateway-status-'.$gateway_name.'" value="'.$gateway_status_value.'" type="checkbox" class="outline-none color-4 bg-2 m-inline-block-dp s-inline-block-dp outline-none m-width-auto s-width-auto m-margin-bm-1 s-margin-bm-1" />
                                    <label for="gateway-switch-'.$gateway_name.'" style="user-select: auto;" class="a-cursor m-font-size-14 s-font-size-16">'.$gateway_status.'</label>
                                </div><br/>';
                    }
                ?>
                    
                <button name="update-gateway-details" type="submit" style="user-select: auto;" class="button-box a-cursor outline-none color-2 bg-7 m-inline-block-dp s-inline-block-dp outline-none onhover-bg-color-5 br-radius-5px br-width-4 br-color-4 m-width-63 s-width-47 m-padding-tp-2 s-padding-tp-1 m-padding-bm-2 s-padding-bm-1 m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-margin-bm-1 s-margin-bm-1" >
