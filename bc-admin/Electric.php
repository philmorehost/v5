<?php session_start();
    ...
    if(isset($_POST["install-product"])){
        ...
        $products_array = array("ekedc","eedc","ikedc","jedc","kedco","ibedc","phed","aedc","yedc","bedc","aple","kaedco");
            ...
            if(!empty($product_name)){
                if(in_array($product_name, $products_array)){
                    if(is_numeric($item_status) && in_array($item_status, array("0", "1"))){
                        $select_api_lists = mysqli_query($connection_server, "SELECT * FROM sas_apis WHERE vendor_id='".$get_logged_admin_details["id"]."' && id='$api_id' && api_type='electric'");
                        $select_electric_status_lists = mysqli_query($connection_server, "SELECT * FROM sas_electric_status WHERE vendor_id='".$get_logged_admin_details["id"]."' && product_name='$product_name'");
                        if(mysqli_num_rows($select_api_lists) == 1){    
                            if(mysqli_num_rows($select_electric_status_lists) == 0){
                                mysqli_query($connection_server, "INSERT INTO sas_electric_status (vendor_id, api_id, product_name, status) VALUES ('".$get_logged_admin_details["id"]."', '$api_id', '$product_name', '$item_status')");
                            }else{
                                mysqli_query($connection_server, "UPDATE sas_electric_status SET api_id='$api_id', status='$item_status' WHERE vendor_id='".$get_logged_admin_details["id"]."' && product_name='$product_name'");
                            }
                            ...
                            foreach($account_level_table_name_arrays as $account_level_table_name){ 
                                ...
                                if(mysqli_num_rows($select_product_details) == 1){
                                    ...
                                    $select_all_api_lists = mysqli_query($connection_server, "SELECT * FROM sas_apis WHERE vendor_id='".$get_logged_admin_details["id"]."' && api_type='electric'");
                        ...
                        //Invalid Electric Status
                        $json_response_array = array("desc" => "Invalid Electric Status");
                        $json_response_encode = json_encode($json_response_array,true);
                    }
                }else{
...
<body>
    <?php include("../func/bc-admin-header.php"); ?>    
        <div style="text-align: center;" class="bg-10 m-block-dp s-block-dp m-position-rel s-position-rel br-radius-5px m-width-94 s-width-94 m-height-auto s-height-auto m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-padding-tp-5 s-padding-tp-3 m-padding-bm-5 s-padding-bm-3 m-margin-lt-2 s-margin-lt-2 m-margin-bm-2 s-margin-bm-2">
            <span style="user-select: auto;" class="text-bg-1 color-4 text-bold-500 m-font-size-25 s-font-size-30 m-inline-block-dp s-inline-block-dp m-margin-bm-1 s-margin-bm-1">ELECTRIC SETTINGS</span><br>
            ...
            <div style="text-align: center; user-select: auto;" class="bg-3 m-inline-block-dp s-inline-block-dp m-width-70 s-width-50 m-margin-tp-1 s-margin-tp-1 m-margin-bm-0 s-margin-bm-0">
                <img alt="ekedc" id="ekedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/ekedc.jpg" onclick="tickProduct(this, 'ekedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 "/>
                <img alt="eedc" id="eedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/eedc.jpg" onclick="tickProduct(this, 'eedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="ikedc" id="ikedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/ikedc.jpg" onclick="tickProduct(this, 'ikedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="jedc" id="jedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/jedc.jpg" onclick="tickProduct(this, 'jedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="kedco" id="kedco-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/kedco.jpg" onclick="tickProduct(this, 'kedco', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="ibedc" id="ibedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/ibedc.jpg" onclick="tickProduct(this, 'ibedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="phed" id="phed-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/phed.jpg" onclick="tickProduct(this, 'phed', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
                <img alt="aedc" id="aedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/aedc.jpg" onclick="tickProduct(this, 'aedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
            	<img alt="yedc" id="yedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/yedc.jpg" onclick="tickProduct(this, 'yedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
            	<img alt="bedc" id="bedc-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/bedc.jpg" onclick="tickProduct(this, 'bedc', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
            	<img alt="aple" id="aple-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/aple.jpg" onclick="tickProduct(this, 'aple', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
            	<img alt="kaedco" id="kaedco-lg" product-name-array="ekedc,eedc,ikedc,jedc,kedco,ibedc,phed,aedc,yedc,bedc,aple,kaedco" src="/asset/kaedco.jpg" onclick="tickProduct(this, 'kaedco', 'api-product-name', 'install-product', 'jpg');" class="a-cursor bg-2 br-radius-100px m-inline-block-dp s-inline-block-dp onhover-img-filter m-width-20 s-width-22 m-margin-tp-1 s-margin-tp-1 m-margin-bm-1 s-margin-bm-1 m-margin-lt-1 s-margin-lt-1"/>
            ...
            <form method="post" action="">
                ...
                <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                    <span id="user-status-span" class="a-cursor" style="user-select: auto;">ELECTRIC STATUS</span>
                </div><br/>
            ...
            <div style="border: 1px solid var(--color-4); user-select: auto; cursor: grab;" class="bg-3 m-inline-block-dp s-inline-block-dp m-width-90 s-width-47 m-height-auto s-height-auto m-scroll-x s-scroll-x m-margin-lt-0 s-margin-lt-0">
                <table style="width: 100% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
                    ...
                    <?php
                        $item_name_array = array("ekedc","eedc","ikedc","jedc","kedco","ibedc","phed","aedc","yedc","bedc","aple","kaedco");
            ...
            <span style="user-select: auto;" class="color-4 text-bold-600 m-font-size-18 s-font-size-20 m-inline-block-dp s-inline-block-dp m-margin-tp-2 s-margin-tp-2 m-margin-bm-1 s-margin-bm-1">ELECTRIC DISCOUNT</span><br>
            <div style="border: 1px solid var(--color-4); user-select: auto; cursor: grab;" class="bg-3 m-inline-block-dp s-inline-block-dp m-width-90 s-width-47 m-height-auto s-height-auto m-scroll-x s-scroll-x m-margin-lt-0 s-margin-lt-0">
                <form method="post" action="">
                    <table style="width: 100% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
                        <tr>
                        ...
                        <?php
                            $item_name_array_2 = array("ekedc","eedc","ikedc","jedc","kedco","ibedc","phed","aedc","yedc","bedc","aple","kaedco");
                            foreach($item_name_array_2 as $products){
                                $get_item_status_details = mysqli_fetch_array(mysqli_query($connection_server, "SELECT * FROM sas_electric_status WHERE vendor_id='".$get_logged_admin_details["id"]."' && product_name='$products'"));
            ...
            <a onclick='downloadFile(`<?php echo implode("\n",$csv_price_level_array); ?>`, "electric.csv");' style="text-decoration: underline; user-select: auto;" class="a-cursor color-2 outline-none text-bold-600">Download Price CSV</a>
