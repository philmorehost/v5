...
<body>
    ...
    <div class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-margin-bm-2 s-margin-bm-2">
        <div style="text-align: center;"
            ...
            <span style="user-select: auto;" class="text-bg-1 color-4 text-bold-600 m-font-size-20 s-font-size-25">SALES
                CALCULATOR</span><br>
            <form method="get" action="SalesCalculator.php" class="m-margin-tp-1 s-margin-tp-1">
