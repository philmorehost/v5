...
<?php
    if(isset($_POST["buy_data"])){
        ...
        $dataType = mysqli_real_escape_string($connection_server, trim(strip_tags($_POST["data-type"])));
        $dataPlan = mysqli_real_escape_string($connection_server, trim(strip_tags($_POST["data-plan"])));
                        ...
                        <div class="card-body">
                            <form method="post" action="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="data-type" id="data-type" required>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" name="data-plan" id="data-plan" required>
                                        <option value="">Select Data Plan</option>
                                    </select>
                                </div>
                                <button type="submit" name="buy_data" class="btn btn-primary">Buy Now</button>
                            </form>
                        </div>
                    </div>
                </div>
