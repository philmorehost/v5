...
if (in_array($purchase_method, $purchase_method_array)) {
    ...
    $electric_type_array = array("ekedc", "eedc", "ikedc", "jedc", "kedco", "ibedc", "phed", "aedc", "yedc", "bedc", "aple", "kaedco");
        ...
        if ($action_function == 1) {
            if (!empty(userBalance(1)) && is_numeric(userBalance(1)) && (userBalance(1) > 0)) {
                if (userBalance(1) >= $amount && !empty($amount) && is_numeric($amount) && !empty($epp) && !empty($type)) {
                    ...
                    $electric_type_table_name_arrays = array("ekedc" => "sas_electric_status", "eedc" => "sas_electric_status", "ikedc" => "sas_electric_status", "jedc" => "sas_electric_status", "kedco" => "sas_electric_status", "ibedc" => "sas_electric_status", "phed" => "sas_electric_status", "aedc" => "sas_electric_status", "yedc" => "sas_electric_status", "bedc" => "sas_electric_status", "aple" => "sas_electric_status", "kaedco" => "sas_electric_status");
                                                ...
                                                if (($product_table["status"] == 1) && ($product_status_table["status"] == 1)) {
                                                    if (productIDBlockChecker($meter_number) == "success") {
                                                        if (productIDPurchaseChecker($meter_number, "electric") == "success") {
                                                            ...
                                                            //Error: Daily Limit Exceeded For This Meter Number 
                                                        ...
                                                        //Error: Meter number has been blocked
