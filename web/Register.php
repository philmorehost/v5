...
<body>	
    <div style="text-align: center;" class="bg-10 m-block-dp s-block-dp m-position-abs s-position-abs br-radius-5px m-width-94 s-width-50 m-height-auto s-height-auto m-padding-lt-1 s-padding-lt-1 m-padding-rt-1 s-padding-rt-1 m-padding-tp-6 s-padding-tp-3 m-padding-bm-5 s-padding-bm-3 m-margin-tp-13 s-margin-tp-2 m-margin-lt-2 s-margin-lt-24">
        ...
        <span style="user-select: auto;" class="text-bg-1 color-4 m-inline-block-dp s-inline-block-dp text-bold-500 m-font-size-20 s-font-size-25 m-margin-bm-2 s-margin-bm-2">CREATE ACCOUNT</span><br>
        <form method="post" action="">
            ...
            <div style="text-align: center;" class="color-4 bg-3 m-inline-block-dp s-inline-block-dp m-font-size-14 s-font-size-16 m-width-60 s-width-45">
                <span id="admin-status-span" class="a-cursor" style="user-select: auto;">Referred by: <?php echo ucwords($check_user_referral_details["firstname"]." ".$check_user_referral_details["lastname"]).checkIfEmpty(ucwords($check_user_referral_details["othername"]), ", ", ""); ?></span>
            </div><br/>
            <?php } ?>
            <div class=" m-inline-block-dp s-inline-block-dp m-width-62 s-width-50">	
