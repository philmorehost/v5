	...
	<?php include("../func/bc-header.php"); ?>
		<div class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-margin-bm-2 s-margin-bm-2">
			<div class="bg-3 m-width-96 s-width-96 m-height-auto s-height-auto m-margin-tp-5 s-margin-tp-2 m-margin-lt-2 s-margin-lt-2">
				<span style="user-select: auto;" class="text-bg-1 color-4 text-bold-600 m-font-size-20 s-font-size-25">PRODUCT PRICING</span><br>
			</div>
		</div>
		<a href="#airtime-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('airtime-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				AIRTIMEVTU PRICE
			</button>
		</a>
		
		<a href="#data-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('data-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				INTERNET DATA PRICE
			</button>
		</a>

		<a href="#cable-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('cable-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				CABLE SUBSCRIPTION PRICE
			</button>
		</a>
		
		<a href="#exam-pin-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('exam-pin-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				EXAM PIN PRICE
			</button>
		</a>
		
		<a href="#electric-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('electric-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				ELECTRIC PRICE
			</button>
		</a>
		
		<a href="#card-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('card-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				CARD PRICE
			</button>
		</a>

		<a href="#bulk-sms-pricing" style="text-decoration: none;">
			<button style="user-select: auto;" onclick="slideDocs('bulk-sms-pricing');" class="button-box br-none a-cursor color-4 bg-10 onhover-bg-color-7 m-inline-block-dp s-inline-block-dp m-width-96 s-width-47 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
				BULK SMS PRICE
			</button>
		</a>

		<div id="airtime-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
		...
		<div id="data-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
			<div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
				<table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
				<tr>
		...
		<div id="cable-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
			<div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
				<table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
				<tr>
		...
		<div id="exam-pin-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
			<div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
				<table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
				<tr>
		...
		<div id="electric-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
			<div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
				<table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
				<tr>
        ...
        <div id="card-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
            <div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
                <table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
                <tr>
		...
		<div id="bulk-sms-pricing" class="pricing_docs_div color-4 bg-3 m-none-dp s-none-dp m-width-96 s-width-96 m-height-0 s-height-0 m-margin-lt-2 s-margin-lt-2 m-padding-tp-1 s-padding-tp-1 m-padding-bm-1 s-padding-bm-1">
            <div style="border: 1px solid var(--color-4); user-select: auto;" class="bg-3 m-width-100 s-width-100 m-height-auto s-height-auto m-scroll-x s-scroll-x">
                <table style="width: 130% !important;" class="table-tag m-font-size-12 s-font-size-14" title="Horizontal Scroll: Shift + Mouse Scroll Button">
                <tr>
